...
static void UpdateLegendaryMarkingColor(u8 frameNum) //Modified for the regigigas title screen
{
    if ((frameNum % 4) == 0) // Change color every 4th frame
    {
        s32 intensity = Cos(frameNum, 128) + 128;
        s32 r = 31 - (intensity * 24 / 256);
        s32 g = 31 - (intensity * 27 / 256);
        s32 b = 12 - (intensity *  9 / 256);
