...
//new pokemon
	...
	SPECIES_TO_HOENN(DUNKETRA),
	SPECIES_TO_HOENN(DUNKEEP),
	SPECIES_TO_HOENN(DUNKASMA),
	SPECIES_TO_HOENN(HATCHICK),
	SPECIES_TO_HOENN(CHICKLET),
	SPECIES_TO_HOENN(COCKATRIX),
...
//new pokemon
	...
	SPECIES_TO_NATIONAL(DUNKETRA),
	SPECIES_TO_NATIONAL(DUNKEEP),
	SPECIES_TO_NATIONAL(DUNKASMA),
	SPECIES_TO_NATIONAL(HATCHICK),
	SPECIES_TO_NATIONAL(CHICKLET),
	SPECIES_TO_NATIONAL(COCKATRIX),
...
//new pokemon
	...
	HOENN_TO_NATIONAL(DUNKETRA),
	HOENN_TO_NATIONAL(DUNKEEP),
	HOENN_TO_NATIONAL(DUNKASMA),
	HOENN_TO_NATIONAL(HATCHICK),
	HOENN_TO_NATIONAL(CHICKLET),
	HOENN_TO_NATIONAL(COCKATRIX),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
	...
	[SPECIES_DUNKETRA - 1]    = ANIM_V_JUMPS_BIG,
	[SPECIES_DUNKEEP - 1]     = ANIM_V_SHAKE,
	[SPECIES_DUNKASMA - 1]    = ANIM_V_SLIDE_WOBBLE,
	[SPECIES_HATCHICK - 1]    = ANIM_SWING_CONCAVE,
    [SPECIES_CHICKLET - 1]    = ANIM_V_STRETCH,
	[SPECIES_COCKATRIX - 1]   = ANIM_H_SHAKE,
    ...
    [SPECIES_ELASTRIKE - 1]   = ANIM_H_JUMPS_V_STRETCH,
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (gBattleMoves[gCurrentMove].effect == EFFECT_EXPLOSION)
        defense /= 2;
	if (type == TYPE_FIRE && attacker->ability == ABILITY_CALDERA)
        gBattleMovePower = (150 * gBattleMovePower) / 100;
	if (type == TYPE_WATER && attacker->ability == ABILITY_CISTERN)
        gBattleMovePower = (150 * gBattleMovePower) / 100;
