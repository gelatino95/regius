...
static const u8 sSpeciesToBackAnimSet[] =
{
	...
	//new pokemon
	[SPECIES_PLAKOMASK]   = BACK_ANIM_V_STRETCH,
	[SPECIES_DUNKETRA]   = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_DUNKEEP]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DUNKASMA]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_HATCHICK]     = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CHICKLET]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_COCKATRIX]   = BACK_ANIM_V_SHAKE,
    [SPECIES_LITTURCH]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_PELURCHIN]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_BENTHINE]     = BACK_ANIM_TRIANGLE_DOWN,
	[SPECIES_KELPENT]    = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_LEVILITH]     = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_CORPOLITH]     = BACK_ANIM_V_SHAKE_LOW,
	[SPECIES_COCONIT]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_PALMODON]     = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_CALFUMP]     = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SIRENITEE]    = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_QUETINI]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_QUETZIN]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_CASSOWILY]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CATRIC]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_AMPEDO]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_ZAMIAD]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_FRONDULA]     = BACK_ANIM_JOLT_RIGHT,
	[SPECIES_SLOTHER]    = BACK_ANIM_JOLT_RIGHT,
	[SPECIES_GLADITHER]    = BACK_ANIM_H_SHAKE,
    [SPECIES_FRIONE]    = BACK_ANIM_DIP_RIGHT_SIDE,
	[SPECIES_FRIGALA]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_FRIGESTY]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_HELIMAW]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_COPRISAW]    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BIBLIT]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_BIBFERNO]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_ELASTRIKE]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
	[SPECIES_MAGVA]      = BACK_ANIM_V_SHAKE_H_SLIDE,
	[SPECIES_PUPAVA]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_VOLQUITO]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_CEBORA]  = BACK_ANIM_H_SLIDE,
    [SPECIES_MANOBELLUM]  = BACK_ANIM_H_SLIDE,
    [SPECIES_COWRENSEA]  = BACK_ANIM_H_SLIDE,
    [SPECIES_MAGMACLE]     = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_LIMPACLE]   = BACK_ANIM_H_SLIDE,
    [SPECIES_TERRISLA]  = BACK_ANIM_V_SHAKE,
    [SPECIES_REGIGIGAS]    = BACK_ANIM_GROW_STUTTER,
};
