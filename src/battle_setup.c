...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_DUSTY] = REMATCH(TRAINER_TANNER, TRAINER_MILTON, TRAINER_AUDREY, TRAINER_HOGARTH, TRAINER_ARIANA, ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_KEGAN, TRAINER_ZEKE, TRAINER_APOLLO, TRAINER_HAROLD, TRAINER_BETSY, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_HOLDEN, TRAINER_LESLIE, TRAINER_GLEN, TRAINER_LYRA, TRAINER_AKIRA, ROUTE109),
    ...
    [REMATCH_BROOKE] = REMATCH(TRAINER_GILLIGAN, TRAINER_CASADY, TRAINER_ARATAKA, TRAINER_HANS, TRAINER_ASTRID, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_LANDON, TRAINER_MAURICE, TRAINER_GIORNO, TRAINER_RAUL, TRAINER_ZHAO, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_TAMARA, TRAINER_HANK, TRAINER_HIBIKI, TRAINER_TINA, TRAINER_ELWYN, MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_MELODY, TRAINER_FRANCINE, TRAINER_MILES, TRAINER_FRANCISCO, TRAINER_ANGUS, ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_MAGNUS, TRAINER_THALIA_2, TRAINER_THALIA_3, TRAINER_THALIA_4, TRAINER_THALIA_5, ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_DEBORAH, TRAINER_LESTER_2, TRAINER_LESTER_3, TRAINER_DRACAENA, TRAINER_HELENA, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_FITZGERALD, TRAINER_TOBY, TRAINER_RADOVAN, TRAINER_MIKA, TRAINER_LUCIAN, ROUTE104),
    [REMATCH_STEVE] = REMATCH(TRAINER_ADELAIDE, TRAINER_HENDRICK, TRAINER_AURELIA, TRAINER_SUZAKU, TRAINER_PATRICK, ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_MIRANDA, TRAINER_TONY_2, TRAINER_TONY_3, TRAINER_TONY_4, TRAINER_TONY_5, ROUTE107),
...
void BattleSetup_StartTrainerBattle(void)
{
	...
	if (gTrainerBattleMode == TRAINER_BATTLE_DETECT
		|| gTrainerBattleMode == TRAINER_BATTLE_CONTINUE_SCRIPT_DETECT
		|| gTrainerBattleMode == TRAINER_BATTLE_CONTINUE_SCRIPT_DETECT_NO_MUSIC
		...
		|| gTrainerBattleMode == TRAINER_BATTLE_GROTTO_NO_MUSIC)
	{
        ...
        if (gTrainerBattleMode == TRAINER_BATTLE_GROTTO //If in the battle grotto, set the var that turns off prize money
            || gTrainerBattleMode == TRAINER_BATTLE_GROTTO_NO_MUSIC)
        VarSet(VAR_0x800B, 1);
        else
        VarSet(VAR_0x800B, 0);
...
{
    CreateFemaleMon(&gEnemyParty[0], SPECIES_DUSCLOPS, 30);
}
