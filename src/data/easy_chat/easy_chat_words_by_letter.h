...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_WORD_BELONGS_TO,
    EC_WORD_BELOW,
    EC_POKEMON_NATIONAL(BENTHINE),
    EC_WORD_BERRY,
    EC_WORD_BESIDE,
    EC_WORD_BEST,
    EC_WORD_BETTER,
    EC_POKEMON_NATIONAL(BIBFERNO),
    EC_POKEMON_NATIONAL(BIBLIT),
    EC_MOVE(BIDE),
    EC_WORD_BIG,
    EC_WORD_BIKE,
    EC_MOVE(BIND),
...
const u16 gEasyChatWordsByLetter_C[] = {
    ...
    EC_POKEMON(CARVANHA),
    EC_POKEMON(CASCOON),
    EC_POKEMON_NATIONAL(CASSOWILY),
    EC_WORD_CASE,
    EC_POKEMON(CASTFORM),
    EC_POKEMON_NATIONAL(CATERPIE),
    EC_POKEMON_NATIONAL(CATRIC),
    EC_WORD_CAUSE,
    EC_POKEMON_NATIONAL(CEBORA),
    ...
    EC_POKEMON_NATIONAL(COCKATRIX),
    EC_POKEMON_NATIONAL(COCONIT),
    EC_WORD_COLD,
    EC_WORD_COLLECT,
    EC_WORD_COLLECTION,
    EC_WORD_COLOR,
    ...
    EC_WORD_COOL,
    EC_WORD_COOLNESS,
    EC_POKEMON_NATIONAL(COPRISAW),
    EC_POKEMON(CORPHISH),
    EC_POKEMON_NATIONAL(CORPOLITH),
    EC_WORD_CORRECT,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(CORSOLA),
...
const u16 gEasyChatWordsByLetter_D[] = {
	...
	EC_POKEMON_NATIONAL(DUNKEEP),
	EC_POKEMON_NATIONAL(DUNKASMA),
	EC_POKEMON_NATIONAL(DUNKETRA),
...
const u16 gEasyChatWordsByLetter_F[] = {
    ...
    EC_WORD_FRIDAY,
    EC_WORD_FRIEND,
    EC_POKEMON_NATIONAL(FRIGALA),
    EC_POKEMON_NATIONAL(FRIGESTY),
    EC_POKEMON_NATIONAL(FRIONE),
    EC_WORD_FROM,
...
const u16 gEasyChatWordsByLetter_M[] = {
    ...
    EC_POKEMON_NATIONAL(MANOBELLUM),
...
const u16 gEasyChatWordsByLetter_Q[] = {
    ...
    EC_WORD_QUESTION,
    EC_POKEMON_NATIONAL(QUETINI),
    EC_POKEMON_NATIONAL(QUETZIN),
