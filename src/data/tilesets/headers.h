...
const struct Tileset gTileset_Arid_Island =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Arid_Island,
    .palettes = gTilesetPalettes_Arid_Island,
    .metatiles = gMetatiles_Arid_Island,
    .metatileAttributes = gMetatileAttributes_Arid_Island,
    .callback = InitTilesetAnim_Pacifidlog,
};

const struct Tileset gTileset_AridIslandIndoors =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_AridIslandIndoors,
    .palettes = gTilesetPalettes_AridIslandIndoors,
    .metatiles = gMetatiles_AridIslandIndoors,
    .metatileAttributes = gMetatileAttributes_AridIslandIndoors,
    .callback = NULL,
};

const struct Tileset gTileset_Kapok_Island =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Kapok_Island,
    .palettes = gTilesetPalettes_Kapok_Island,
    .metatiles = gMetatiles_Kapok_Island,
    .metatileAttributes = gMetatileAttributes_Kapok_Island,
    .callback = InitTilesetAnim_Pacifidlog,
};

const struct Tileset gTileset_Pirate_Ship =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Pirate_Ship,
    .palettes = gTilesetPalettes_Pirate_Ship,
    .metatiles = gMetatiles_Pirate_Ship,
    .metatileAttributes = gMetatileAttributes_Pirate_Ship,
    .callback = NULL,
};

const struct Tileset gTileset_SouthSea =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SouthSea,
    .palettes = gTilesetPalettes_SouthSea,
    .metatiles = gMetatiles_SouthSea,
    .metatileAttributes = gMetatileAttributes_SouthSea,
    .callback = NULL,
};

const struct Tileset gTileset_BattleGrotto =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_BattleGrotto,
    .palettes = gTilesetPalettes_BattleGrotto,
    .metatiles = gMetatiles_BattleGrotto,
    .metatileAttributes = gMetatileAttributes_BattleGrotto,
    .callback = NULL,
};