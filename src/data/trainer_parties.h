...
static const struct TrainerMon sParty_Rosie[] = {
    {
    .iv = 0,
    .lvl = 13,
    .species = SPECIES_KELPENT,
    },
    {
    .iv = 0,
    .lvl = 13,
...
static const struct TrainerMon sParty_Armin[] = {
    {
    .iv = 0,
    .lvl = 14,
    .species = SPECIES_HELIMAW,
...
static const struct TrainerMon sParty_Custer[] = {
    {
    .iv = 0,
    .lvl = 15,
...
static const struct TrainerMon sParty_Mindy[] = {
    {
    .iv = 0,
    .lvl = 14,
...
static const struct TrainerMon sParty_Michaela[] = {
    {
    .iv = 0,
    .lvl = 15,
...
static const struct TrainerMon sParty_Milton[] = {
    {
    .iv = 0,
    .lvl = 16,
    .species = SPECIES_KELPENT
...
static const struct TrainerMon sParty_Hogarth[] = {
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_NUMEL
...
static const struct TrainerMon sParty_Ariana[] = {
    {
    .iv = 90,
    .lvl = 18,
    .species = SPECIES_LUVDISC
...
static const struct TrainerMon sParty_Ronaldo[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_CHICKLET,
...
static const struct TrainerMon sParty_Lukas[] = {
    {
    .iv = 0,
    .lvl = 16,
...
static const struct TrainerMon sParty_Lissy[] = {
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_PLUSLE,
...
static const struct TrainerMon sParty_Francesca[] = {
    {
    .iv = 0,
    .lvl = 15,
...
static const struct TrainerMon sParty_Kegan[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_LITTURCH,
...
static const struct TrainerMon sParty_Zeke[] = {
    {
    .iv = 0,
    .lvl = 16,
...
static const struct TrainerMon sParty_Apollo[] = {
    {
    .iv = 0,
    .lvl = 16,
    .species = SPECIES_MAKUHITA,
...
static const struct TrainerMon sParty_Betsy[] = {
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_LITTURCH,
...
static const struct TrainerMon sParty_Lyra[] = {
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_MAKUHITA,
...
static const struct TrainerMon sParty_Candace[] = {
    {
    .iv = 0,
    .lvl = 25,
    .species = SPECIES_CORSOLA,
...
static const struct TrainerMon sParty_Landon[] = {
    {
    .iv = 0,
    .lvl = 20,
    .species = SPECIES_CALFUMP,
    ...
    .iv = 0,
    .lvl = 20,
    .species = SPECIES_COWRENSEA,
    .heldItem = ITEM_NUGGET,
    }
};

static const struct TrainerMon sParty_Richmond[] = {
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_REMORAID,
...
static const struct TrainerMon sParty_Randy[] = {
    {
    .iv = 0,
    .lvl = 21,
    .species = SPECIES_RELICANTH,
    .heldItem = ITEM_GREEN_SHARD,
    },
    {
    .iv = 0,
    .lvl = 21,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_RED_SHARD,
    }
};

static const struct TrainerMon sParty_Abdul[] = {
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_WINGULL,
...
static const struct TrainerMon sParty_Gilligan[] = {
    {
    .iv = 100,
    .lvl = 23,
    .species = SPECIES_SHELLDER,
    ...
    .moves = {MOVE_CLAMP, MOVE_SUPERSONIC, MOVE_PROTECT, MOVE_AURORA_BEAM}
    }
};

static const struct TrainerMon sParty_Boone[] = {
    {
    .iv = 0,
    .lvl = 25,
...
static const struct TrainerMon sParty_Linneus[] = {
    {
    .iv = 0,
    .lvl = 26,
    .species = SPECIES_MAGVA,
...
static const struct TrainerMon sParty_Nam[] = {
    {
    .iv = 0,
    .lvl = 27,
    .species = SPECIES_SHUCKLE,
...
static const struct TrainerMon sParty_Julie[] = {
    ...
    .heldItem = ITEM_YELLOW_SHARD,
    }
};

static const struct TrainerMon sParty_Casady[] = {
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_MAGMACLE,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_FIRE_SPIN, MOVE_MUD_SLAP, MOVE_PROTECT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EMBER, MOVE_ROCK_THROW, MOVE_SMOG, MOVE_ROCK_THROW}
    },
    {
    .iv = 100,
    .lvl = 28,
    ...
    .moves = {MOVE_FIRE_PUNCH, MOVE_MEGA_PUNCH, MOVE_LEER, MOVE_SUNNY_DAY}
    },
};

static const struct TrainerMon sParty_Arataka[] = {
    {
    .iv = 0,
    .lvl = 30,
...
static const struct TrainerMon sParty_Hans[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_QUETINI,
...
static const struct TrainerMon sParty_Astrid[] = {
    {
    .iv = 0,
    .lvl = 31,
    .species = SPECIES_CEBORA,
...
static const struct TrainerMon sParty_Keito[] = {
    {
    .iv = 0,
    .lvl = 31,
...
static const struct TrainerMon sParty_Yuri[] = {
    {
    .iv = 0,
    .lvl = 32,
    .species = SPECIES_ANORITH,
...
static const struct TrainerMon sParty_Tamara[] = {
    ...
    .species = SPECIES_CALFUMP,
    .heldItem = ITEM_PECHA_BERRY,
    .moves = {MOVE_LEECH_SEED, MOVE_HELPING_HAND, MOVE_AROMATHERAPY, MOVE_BODY_SLAM}
    },
    {
    .iv = 100,
    .lvl = 34,
    ...
    .moves = {MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_MEGA_KICK}
    }
};
...
static const struct TrainerMon sParty_Hibiki[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_SUNFLORA,
...
static const struct TrainerMon sParty_Tina[] = {
    {
    .iv = 50,
    .lvl = 33,
    .species = SPECIES_PALMODON,
    .heldItem = ITEM_CHERI_BERRY,
    .moves = {MOVE_SLASH, MOVE_BARRAGE, MOVE_STUN_SPORE, MOVE_BULLET_SEED}
    },
    {
    .iv = 50,
    .lvl = 33,
...
static const struct TrainerMon sParty_Elwyn[] = {
    {
    .iv = 50,
    .lvl = 32,
    .species = SPECIES_SKARMORY,
    ...
    .iv = 50,
    .lvl = 32,
    .species = SPECIES_SIRENITEE,
    .heldItem = ITEM_PEARL,
    }
};

static const struct TrainerMon sParty_Melody[] = {
    {
    .iv = 0,
    .lvl = 30,
    .species = SPECIES_PELURCHIN,
...
static const struct TrainerMon sParty_Augustus[] = {
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_CORSOLA,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_CLAMP, MOVE_IRON_DEFENSE, MOVE_WHIRLPOOL}
    }
};

static const struct TrainerMon sParty_Tulio[] = {
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_GOREBYSS,
...
static const struct TrainerMon sParty_Natalie[] = {
    {
    .iv = 0,
    .lvl = 26,
    .species = SPECIES_CEBORA,
...
static const struct TrainerMon sParty_Ikechi[] = {
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_CHINCHOU,
...
static const struct TrainerMon sParty_Francine[] = {
    {
    .iv = 0,
    .lvl = 29,
    .species = SPECIES_RADULIN,
...
static const struct TrainerMon sParty_Miles[] = {
    {
    .iv = 0,
    .lvl = 29,
    .species = SPECIES_GYARADOS,
...
static const struct TrainerMon sParty_Francisco[] = {
    {
    .iv = 0,
    .lvl = 31,
    .species = SPECIES_GYARADOS,
...
static const struct TrainerMon sParty_Dracaena[] = {
    ...
    .moves = {MOVE_WATERFALL, MOVE_SUBMISSION, MOVE_SKULL_BASH, MOVE_CURSE}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 52,
...
static const struct TrainerMon sParty_Helena[] = {
    {
    .iv = 0,
    .lvl = 35,
    .species = SPECIES_CEBORA,
...
static const struct TrainerMon sParty_Fitzgerald[] = {
    {
    .iv = 0,
    .lvl = 35,
    .species = SPECIES_RADULIN,
...
static const struct TrainerMon sParty_Priya[] = {
    {
    .iv = 0,
    .lvl = 36,
    .species = SPECIES_QWILFISH,
...
static const struct TrainerMon sParty_Radovan[] = {
    {
    .iv = 0,
    .lvl = 37,
    .species = SPECIES_LIMPACLE,
    ...
    .iv = 0,
    .lvl = 37,
    .species = SPECIES_TOXULA,
    }
};

static const struct TrainerMon sParty_Mika[] = {
    {
    .iv = 150,
    .lvl = 38,
    .species = SPECIES_WAILMER,
    .heldItem = ITEM_PERSIM_BERRY,
    .moves = {MOVE_MIST, MOVE_ROLLOUT, MOVE_WHIRLPOOL, MOVE_WATER_PULSE}
    },
    {
    .iv = 150,
    .lvl = 38,
    .species = SPECIES_FRIGALA,
    .moves = {MOVE_TEETER_DANCE, MOVE_ICY_WIND, MOVE_BITE, MOVE_MAGIC_COAT}
    },
    {
    .iv = 150,
    .lvl = 38,
    .species = SPECIES_CLAMPERL,
    .heldItem = ITEM_DEEP_SEA_TOOTH,
    .moves = {MOVE_ICE_BEAM, MOVE_SURF, MOVE_CLAMP, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_COPRISAW,
    .heldItem = ITEM_METAL_COAT,
    .moves = {MOVE_METAL_CLAW, MOVE_CRUNCH, MOVE_TAUNT, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMon sParty_Adelaide[] = {
    {
    .iv = 0,
    .lvl = 40,
...
static const struct TrainerMon sParty_Magnus[] = {
    {
    .iv = 0,
    .lvl = 41,
    .species = SPECIES_SLUGMA,
...
static const struct TrainerMon sParty_Lillie[] = {
    {
    .iv = 0,
    .lvl = 42,
    .species = SPECIES_LAPRAS,
...
static const struct TrainerMon sParty_Hendrick[] = {
    {
    .iv = 0,
    .lvl = 42,
    .species = SPECIES_QUETZIN,
...
static const struct TrainerMon sParty_Aurelia[] = {
    ...
    .lvl = 43,
    .species = SPECIES_MISDREAVUS,
    .moves = {MOVE_PSYBEAM, MOVE_CONFUSE_RAY, MOVE_MEAN_LOOK, MOVE_PAIN_SPLIT}
    },
    {
    .iv = 150,
    .lvl = 43,
    ...
    .species = SPECIES_KECLEON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SCREECH, MOVE_SLASH, MOVE_BIND, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_FRIGESTY,
    .heldItem = ITEM_NEVER_MELT_ICE,
    .moves = {MOVE_BLIZZARD, MOVE_RECOVER, MOVE_WATER_PULSE, MOVE_CALM_MIND}
    }
};

static const struct TrainerMon sParty_Suzaku[] = {
    {
    .iv = 0,
    .lvl = 45,
    .species = SPECIES_PALMODON,
    .moves = {MOVE_STUN_SPORE, MOVE_SLASH, MOVE_SYNTHESIS, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 0,
    .lvl = 45,
    .species = SPECIES_CRAWDAUNT,
    .moves = {MOVE_SWORDS_DANCE, MOVE_CRABHAMMER, MOVE_KNOCK_OFF, MOVE_TAUNT}
    },
    {
    .iv = 0,
    .lvl = 45,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_FAINT_ATTACK, MOVE_YAWN, MOVE_COUNTER}
    }
};
...
static const struct TrainerMon sParty_Patrick[] = {
    ...
    .species = SPECIES_MINUN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HELPING_HAND, MOVE_THUNDER_WAVE, MOVE_RAIN_DANCE, MOVE_THUNDERBOLT}
    },
    {
    .iv = 0,
    .lvl = 45,
    .species = SPECIES_PLUSLE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER, MOVE_FAKE_TEARS, MOVE_QUICK_ATTACK, MOVE_AGILITY}
    },
    {
    .iv = 0,
    .lvl = 45,
    .species = SPECIES_AMPEDO,
    .moves = {MOVE_THUNDER, MOVE_BUBBLE_BEAM, MOVE_AGILITY, MOVE_CHARGE}
    }
};

static const struct TrainerMon sParty_Hitomi[] = {
    {
    .iv = 0,
    .lvl = 46,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_FAKE_OUT, MOVE_WHIRLWIND, MOVE_VITAL_THROW, MOVE_SMELLING_SALT}
    },
    {
    .iv = 0,
    .lvl = 46,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_MEDITATE, MOVE_HI_JUMP_KICK, MOVE_ICE_PUNCH, MOVE_DETECT}
    },
    {
    .iv = 0,
    .lvl = 46,
    .species = SPECIES_PINSIR,
    .moves = {MOVE_REVENGE, MOVE_BIND, MOVE_SEISMIC_TOSS, MOVE_HARDEN}
    },
    {
    .iv = 0,
    .lvl = 46,
    .species = SPECIES_ELASTRIKE,
    .moves = {MOVE_LOW_KICK, MOVE_BOUNCE, MOVE_FOCUS_ENERGY, MOVE_SMELLING_SALT}
    }
};

static const struct TrainerMon sParty_Gulliver[] = {
    {
    .iv = 0,
    .lvl = 46,
    .species = SPECIES_KABUTOPS,
    .moves = {MOVE_METAL_SOUND, MOVE_SLASH, MOVE_GIGA_DRAIN, MOVE_MUD_SHOT}
    },
    {
    .iv = 0,
    .lvl = 46,
    .species = SPECIES_OMASTAR,
    .moves = {MOVE_TICKLE, MOVE_SPIKE_CANNON, MOVE_SURF, MOVE_ROCK_TOMB}
    },
    {
    .iv = 0,
    .lvl = 46,
    .species = SPECIES_CORPOLITH,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_BODY_SLAM, MOVE_ANCIENT_POWER, MOVE_CONFUSE_RAY}
    }
};

static const struct TrainerMon sParty_Faith[] = {
    {
    .iv = 0,
    .lvl = 47,
    .species = SPECIES_DUSCLOPS,
    .moves = {MOVE_DISABLE, MOVE_CONFUSE_RAY, MOVE_SHADOW_PUNCH, MOVE_WILL_O_WISP}
    },
    {
    .iv = 0,
    .lvl = 47,
    .species = SPECIES_BIBFERNO,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_FAKE_TEARS, MOVE_NIGHT_SHADE}
    }
};
...
static const struct TrainerMon sParty_Darrin[] = {
    ...
    .moves = {MOVE_SMOKESCREEN, MOVE_TWISTER, MOVE_AGILITY, MOVE_WATER_PULSE}
    },
    {
    .iv = 0,
    .lvl = 47,
    .species = SPECIES_FLYGON,
    .moves = {MOVE_DRAGON_BREATH, MOVE_DIG, MOVE_CRUNCH, MOVE_SCREECH}
    },
    {
    .iv = 0,
    .lvl = 47,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_LEER, MOVE_REST, MOVE_BODY_SLAM, MOVE_WATERFALL}
    }
};

static const struct TrainerMon sParty_Miranda[] = {
    {
    .iv = 200,
    .lvl = 48,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_TOMB, MOVE_COSMIC_POWER, MOVE_PSYCHIC}
    },
    {
    .iv = 200,
    .lvl = 48,
    .species = SPECIES_QUETZIN,
    .moves = {MOVE_HYPER_VOICE, MOVE_FLY, MOVE_MIRROR_MOVE, MOVE_SCREECH}
    },
    {
    .iv = 200,
    .lvl = 48,
    .species = SPECIES_ALGOREST,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SCARY_FACE, MOVE_SLAM, MOVE_SYNTHESIS}
    },
    {
    .iv = 200,
    .lvl = 48,
    .species = SPECIES_HERACROSS,
    .moves = {MOVE_ENDURE, MOVE_REVERSAL, MOVE_COUNTER, MOVE_MEGAHORN}
    },
    {
    .iv = 200,
    .lvl = 49,
    .species = SPECIES_BENTHINE,
    .moves = {MOVE_CRUNCH, MOVE_WHIRLPOOL, MOVE_WATERFALL, MOVE_ACID_ARMOR}
    }
};
...
static const struct TrainerMon sParty_Dahlia[] = {
    {
    .iv = 100,
    .lvl = 29,
    .species = SPECIES_CORSOLA,
