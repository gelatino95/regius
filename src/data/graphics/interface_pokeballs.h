...
const u32 gInterfaceGfx_RegiBall[] = INCBIN_U32("graphics/interface/ball/regi.4bpp.lz");
const u32 gInterfacePal_RegiBall[] = INCBIN_U32("graphics/interface/ball/regi.gbapal.lz");
