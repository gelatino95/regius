const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	//new pokemon
	[SPECIES_PLAKOMASK]  = {{EVO_LEVEL_ATK_LT_DEF, 25, SPECIES_DUNKETRA},
                            {EVO_LEVEL_ATK_GT_DEF, 25, SPECIES_DUNKEEP},
                            {EVO_LEVEL_ATK_EQ_DEF, 25, SPECIES_DUNKASMA}},
	[SPECIES_HATCHICK]   = {{EVO_LEVEL, 15, SPECIES_CHICKLET}},
	[SPECIES_CHICKLET]   = {{EVO_LEVEL, 32, SPECIES_COCKATRIX}},
	[SPECIES_LITTURCH]   = {{EVO_LEVEL, 20, SPECIES_PELURCHIN}},
	[SPECIES_PELURCHIN]  = {{EVO_LEVEL, 36, SPECIES_BENTHINE}},
	[SPECIES_KELPENT]    = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ALGOREST}},
	[SPECIES_RADULIN]    = {{EVO_LEVEL, 28, SPECIES_TOXULA}},
	[SPECIES_GLYPHMITE]  = {{EVO_LEVEL, 18, SPECIES_PYRAMITE}},
	[SPECIES_LEVILITH]   = {{EVO_LEVEL, 32, SPECIES_CORPOLITH}},
	[SPECIES_COCONIT]    = {{EVO_LEVEL, 25, SPECIES_PALMODON}},
	[SPECIES_CALFUMP]    = {{EVO_LEVEL, 32, SPECIES_SIRENITEE}},
	[SPECIES_QUETINI]    = {{EVO_LEVEL, 27, SPECIES_QUETZIN}},
	[SPECIES_CATRIC]     = {{EVO_LEVEL, 27, SPECIES_AMPEDO}},
	[SPECIES_ZAMIAD]     = {{EVO_LEVEL, 40, SPECIES_FRONDULA}},
	[SPECIES_SLOTHER]    = {{EVO_LEVEL, 40, SPECIES_GLADITHER}},
	[SPECIES_FRIONE]     = {{EVO_LEVEL, 26, SPECIES_FRIGALA}},
	[SPECIES_FRIGALA]    = {{EVO_LEVEL, 38, SPECIES_FRIGESTY}},
	[SPECIES_HELIMAW]    = {{EVO_LEVEL, 35, SPECIES_COPRISAW}},
	[SPECIES_BIBLIT]     = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_BIBFERNO}},
	[SPECIES_MAGVA]      = {{EVO_LEVEL, 33, SPECIES_PUPAVA}},
	[SPECIES_PUPAVA]     = {{EVO_LEVEL, 36, SPECIES_VOLQUITO}},
	[SPECIES_CEBORA]     = {{EVO_LEVEL, 33, SPECIES_MANOBELLUM}},
	[SPECIES_MAGMACLE]   = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_TERRISLA}},
	[SPECIES_LIMPACLE]   = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_TERRISLA}},
};
