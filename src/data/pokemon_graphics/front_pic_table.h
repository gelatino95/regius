const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(HATCHICK, gMonFrontPic_Hatchick),
	SPECIES_SPRITE(CHICKLET, gMonFrontPic_Chicklet),
    SPECIES_SPRITE(COCKATRIX, gMonFrontPic_Cockatrix),
	SPECIES_SPRITE(LITTURCH, gMonFrontPic_Litturch),
	SPECIES_SPRITE(PELURCHIN, gMonFrontPic_Pelurchin),
    SPECIES_SPRITE(BENTHINE, gMonFrontPic_Benthine),
	SPECIES_SPRITE(KELPENT, gMonFrontPic_Kelpent),
    SPECIES_SPRITE(ALGOREST, gMonFrontPic_Algorest),
	SPECIES_SPRITE(RADULIN, gMonFrontPic_Radulin),
    SPECIES_SPRITE(TOXULA, gMonFrontPic_Toxula),
	SPECIES_SPRITE(GLYPHMITE, gMonFrontPic_Glyphmite),
    SPECIES_SPRITE(PYRAMITE, gMonFrontPic_Pyramite),
	SPECIES_SPRITE(LEVILITH, gMonFrontPic_Levilith),
    SPECIES_SPRITE(CORPOLITH, gMonFrontPic_Corpolith),
	SPECIES_SPRITE(COCONIT, gMonFrontPic_Coconit),
    SPECIES_SPRITE(PALMODON, gMonFrontPic_Palmodon),
	SPECIES_SPRITE(CALFUMP, gMonFrontPic_Calfump),
    SPECIES_SPRITE(SIRENITEE, gMonFrontPic_Sirenitee),
    SPECIES_SPRITE(QUETINI, gMonFrontPic_Quetini),
    SPECIES_SPRITE(QUETZIN, gMonFrontPic_Quetzin),
    SPECIES_SPRITE(CASSOWILY, gMonFrontPic_Cassowily),
    SPECIES_SPRITE(CATRIC, gMonFrontPic_Catric),
    SPECIES_SPRITE(AMPEDO, gMonFrontPic_Ampedo),
    SPECIES_SPRITE(ZAMIAD, gMonFrontPic_Zamiad),
    SPECIES_SPRITE(FRONDULA, gMonFrontPic_Frondula),
    SPECIES_SPRITE(SLOTHER, gMonFrontPic_Slother),
    SPECIES_SPRITE(GLADITHER, gMonFrontPic_Gladither),
    SPECIES_SPRITE(FRIONE, gMonFrontPic_Frione),
    SPECIES_SPRITE(FRIGALA, gMonFrontPic_Frigala),
    SPECIES_SPRITE(FRIGESTY, gMonFrontPic_Frigesty),
    SPECIES_SPRITE(HELIMAW, gMonFrontPic_Helimaw),
    SPECIES_SPRITE(COPRISAW, gMonFrontPic_Coprisaw),
    SPECIES_SPRITE(BIBLIT, gMonFrontPic_Biblit),
    SPECIES_SPRITE(BIBFERNO, gMonFrontPic_Bibferno),
    SPECIES_SPRITE(ELASTRIKE, gMonFrontPic_Elastrike),
    SPECIES_SPRITE(MAGVA, gMonFrontPic_Magva),
    SPECIES_SPRITE(PUPAVA, gMonFrontPic_Pupava),
    SPECIES_SPRITE(VOLQUITO, gMonFrontPic_Volquito),
    SPECIES_SPRITE(CEBORA, gMonFrontPic_Cebora),
    SPECIES_SPRITE(MANOBELLUM, gMonFrontPic_Manobellum),
    SPECIES_SPRITE(COWRENSEA, gMonFrontPic_Cowrensea),
    SPECIES_SPRITE(MAGMACLE, gMonFrontPic_Magmacle),
    SPECIES_SPRITE(LIMPACLE, gMonFrontPic_Limpacle),
    SPECIES_SPRITE(TERRISLA, gMonFrontPic_Terrisla),
