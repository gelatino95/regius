...
//new pokemon
	...
	SPECIES_PAL(DUNKEEP, gMonPalette_Dunkeep),
	SPECIES_PAL(DUNKASMA, gMonPalette_Dunkasma),
	SPECIES_PAL(HATCHICK, gMonPalette_Hatchick),
	SPECIES_PAL(CHICKLET, gMonPalette_Chicklet),
	SPECIES_PAL(COCKATRIX, gMonPalette_Cockatrix),
	SPECIES_PAL(LITTURCH, gMonPalette_Litturch),
	SPECIES_PAL(PELURCHIN, gMonPalette_Pelurchin),
	SPECIES_PAL(BENTHINE, gMonPalette_Benthine),
	SPECIES_PAL(KELPENT, gMonPalette_Kelpent),
	SPECIES_PAL(ALGOREST, gMonPalette_Algorest),
	SPECIES_PAL(RADULIN, gMonPalette_Radulin),
	...
	SPECIES_PAL(COCONIT, gMonPalette_Coconit),
	SPECIES_PAL(PALMODON, gMonPalette_Palmodon),
	SPECIES_PAL(CALFUMP, gMonPalette_Calfump),
	SPECIES_PAL(SIRENITEE, gMonPalette_Sirenitee),
	SPECIES_PAL(QUETINI, gMonPalette_Quetini),
	SPECIES_PAL(QUETZIN, gMonPalette_Quetzin),
	SPECIES_PAL(CASSOWILY, gMonPalette_Cassowily),
	SPECIES_PAL(CATRIC, gMonPalette_Catric),
	...
	SPECIES_PAL(FRIONE, gMonPalette_Frione),
	SPECIES_PAL(FRIGALA, gMonPalette_Frigala),
	SPECIES_PAL(FRIGESTY, gMonPalette_Frigesty),
	SPECIES_PAL(HELIMAW, gMonPalette_Helimaw),
	SPECIES_PAL(COPRISAW, gMonPalette_Coprisaw),
	SPECIES_PAL(BIBLIT, gMonPalette_Biblit),
	SPECIES_PAL(BIBFERNO, gMonPalette_Bibferno),
	SPECIES_PAL(ELASTRIKE, gMonPalette_Elastrike),
	SPECIES_PAL(MAGVA, gMonPalette_Magva),
	SPECIES_PAL(PUPAVA, gMonPalette_Pupava),
	SPECIES_PAL(VOLQUITO, gMonPalette_Volquito),
	SPECIES_PAL(CEBORA, gMonPalette_Cebora),
	SPECIES_PAL(MANOBELLUM, gMonPalette_Manobellum),
	SPECIES_PAL(COWRENSEA, gMonPalette_Cowrensea),
	SPECIES_PAL(MAGMACLE, gMonPalette_Magmacle),
	SPECIES_PAL(LIMPACLE, gMonPalette_Limpacle),
	SPECIES_PAL(TERRISLA, gMonPalette_Terrisla),
};
