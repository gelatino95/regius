...
static const union AnimCmd sAnim_Plakomask_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_Dunkeep_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 44),
    ANIMCMD_FRAME(0, 10),
...
static const union AnimCmd sAnim_Coconit_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 22),
    ANIMCMD_FRAME(0, 11),
...
static const union AnimCmd sAnim_Palmodon_1[] =
{
    ANIMCMD_FRAME(1, 8),
    ANIMCMD_FRAME(0, 8),
    ANIMCMD_FRAME(1, 8),
...
static const union AnimCmd sAnim_Catric_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 20),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_Ampedo_1[] =
{
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 40),
...
static const union AnimCmd sAnim_Slother_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
...
static const union AnimCmd sAnim_Gladither_1[] =
{
    ANIMCMD_FRAME(0, 5),
    ANIMCMD_FRAME(1, 25),
    ANIMCMD_FRAME(0, 20),
...
static const union AnimCmd sAnim_Biblit_1[] =
{
    ANIMCMD_FRAME(0, 33),
    ANIMCMD_FRAME(1, 33),
    ANIMCMD_FRAME(0, 33),
...
static const union AnimCmd sAnim_Bibferno_1[] =
{
    ANIMCMD_FRAME(1, 40),
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_END,
...
static const union AnimCmd sAnim_Magva_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 22),
    ANIMCMD_FRAME(0, 11),
...
static const union AnimCmd sAnim_Pupava_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 22),
    ANIMCMD_FRAME(0, 11),
...
static const union AnimCmd sAnim_Volquito_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_FRAME(1, 1),
    ANIMCMD_FRAME(0, 1),
...
static const union AnimCmd sAnim_Cebora_1[] =
{
    ANIMCMD_FRAME(0, 8),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 7),
...
static const union AnimCmd sAnim_Manobellum_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
...
static const union AnimCmd sAnim_Cowrensea_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
...
//new pokemon
SINGLE_ANIMATION(Plakomask);
SINGLE_ANIMATION(Dunketra);
SINGLE_ANIMATION(Dunkeep);
SINGLE_ANIMATION(Dunkasma);
SINGLE_ANIMATION(Hatchick);
SINGLE_ANIMATION(Chicklet);
SINGLE_ANIMATION(Cockatrix);
SINGLE_ANIMATION(Litturch);
SINGLE_ANIMATION(Pelurchin);
SINGLE_ANIMATION(Benthine);
SINGLE_ANIMATION(Kelpent);
SINGLE_ANIMATION(Algorest);
SINGLE_ANIMATION(Radulin);
SINGLE_ANIMATION(Toxula);
SINGLE_ANIMATION(Glyphmite);
SINGLE_ANIMATION(Pyramite);
SINGLE_ANIMATION(Levilith);
SINGLE_ANIMATION(Corpolith);
SINGLE_ANIMATION(Coconit);
SINGLE_ANIMATION(Palmodon);
SINGLE_ANIMATION(Calfump);
SINGLE_ANIMATION(Sirenitee);
SINGLE_ANIMATION(Quetini);
SINGLE_ANIMATION(Quetzin);
SINGLE_ANIMATION(Cassowily);
SINGLE_ANIMATION(Catric);
SINGLE_ANIMATION(Ampedo);
SINGLE_ANIMATION(Zamiad);
SINGLE_ANIMATION(Frondula);
SINGLE_ANIMATION(Slother);
SINGLE_ANIMATION(Gladither);
SINGLE_ANIMATION(Frione);
SINGLE_ANIMATION(Frigala);
SINGLE_ANIMATION(Frigesty);
SINGLE_ANIMATION(Helimaw);
SINGLE_ANIMATION(Coprisaw);
SINGLE_ANIMATION(Biblit);
SINGLE_ANIMATION(Bibferno);
SINGLE_ANIMATION(Elastrike);
SINGLE_ANIMATION(Magva);
SINGLE_ANIMATION(Pupava);
SINGLE_ANIMATION(Volquito);
SINGLE_ANIMATION(Cebora);
SINGLE_ANIMATION(Manobellum);
SINGLE_ANIMATION(Cowrensea);
SINGLE_ANIMATION(Magmacle);
SINGLE_ANIMATION(Limpacle);
SINGLE_ANIMATION(Terrisla);
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    //new pokemon
    [SPECIES_PLAKOMASK]   = sAnims_Plakomask,
    [SPECIES_DUNKETRA]    = sAnims_Dunketra,
    [SPECIES_DUNKEEP]     = sAnims_Dunkeep,
    [SPECIES_DUNKASMA]    = sAnims_Dunkasma,
    [SPECIES_HATCHICK]    = sAnims_Hatchick,
    [SPECIES_CHICKLET]    = sAnims_Chicklet,
    [SPECIES_COCKATRIX]   = sAnims_Cockatrix,
    [SPECIES_LITTURCH]    = sAnims_Litturch,
    [SPECIES_PELURCHIN]   = sAnims_Pelurchin,
    [SPECIES_BENTHINE]    = sAnims_Benthine,
    [SPECIES_KELPENT]     = sAnims_Kelpent,
    [SPECIES_ALGOREST]    = sAnims_Algorest,
    [SPECIES_RADULIN]     = sAnims_Radulin,
    [SPECIES_TOXULA]      = sAnims_Toxula,
    [SPECIES_GLYPHMITE]   = sAnims_Glyphmite,
    [SPECIES_PYRAMITE]    = sAnims_Pyramite,
    [SPECIES_LEVILITH]    = sAnims_Levilith,
    [SPECIES_CORPOLITH]   = sAnims_Corpolith,
    [SPECIES_COCONIT]     = sAnims_Coconit,
    [SPECIES_PALMODON]    = sAnims_Palmodon,
    [SPECIES_CALFUMP]     = sAnims_Calfump,
    [SPECIES_SIRENITEE]   = sAnims_Sirenitee,
    [SPECIES_QUETINI]     = sAnims_Quetini,
    [SPECIES_QUETZIN]     = sAnims_Quetzin,
    [SPECIES_CASSOWILY]   = sAnims_Cassowily,
    [SPECIES_CATRIC]      = sAnims_Catric,
    [SPECIES_AMPEDO]      = sAnims_Ampedo,
    [SPECIES_ZAMIAD]      = sAnims_Zamiad,
    [SPECIES_FRONDULA]    = sAnims_Frondula,
    [SPECIES_SLOTHER]     = sAnims_Slother,
    [SPECIES_GLADITHER]   = sAnims_Gladither,
    [SPECIES_FRIONE]      = sAnims_Frione,
    [SPECIES_FRIGALA]     = sAnims_Frigala,
    [SPECIES_FRIGESTY]    = sAnims_Frigesty,
    [SPECIES_HELIMAW]     = sAnims_Helimaw,
    [SPECIES_COPRISAW]    = sAnims_Coprisaw,
    [SPECIES_BIBLIT]      = sAnims_Biblit,
    [SPECIES_BIBFERNO]    = sAnims_Bibferno,
    [SPECIES_ELASTRIKE]   = sAnims_Elastrike,
    [SPECIES_MAGVA]       = sAnims_Magva,
    [SPECIES_PUPAVA]      = sAnims_Pupava,
    [SPECIES_VOLQUITO]    = sAnims_Volquito,
    [SPECIES_CEBORA]      = sAnims_Cebora,
    [SPECIES_MANOBELLUM]  = sAnims_Manobellum,
    [SPECIES_COWRENSEA]   = sAnims_Cowrensea,
    [SPECIES_MAGMACLE]    = sAnims_Magmacle,
    [SPECIES_LIMPACLE]    = sAnims_Limpacle,
    [SPECIES_TERRISLA]    = sAnims_Terrisla,
