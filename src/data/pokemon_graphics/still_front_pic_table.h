...
//new pokemon
	...
	SPECIES_SPRITE(HATCHICK,      gMonStillFrontPic_Hatchick),
	SPECIES_SPRITE(CHICKLET,      gMonStillFrontPic_Chicklet),
	SPECIES_SPRITE(COCKATRIX,     gMonStillFrontPic_Cockatrix),
	SPECIES_SPRITE(LITTURCH,      gMonStillFrontPic_Litturch),
	SPECIES_SPRITE(PELURCHIN,     gMonStillFrontPic_Pelurchin),
	SPECIES_SPRITE(BENTHINE,      gMonStillFrontPic_Benthine),
	SPECIES_SPRITE(KELPENT,       gMonStillFrontPic_Kelpent),
	...
	SPECIES_SPRITE(LEVILITH,      gMonStillFrontPic_Levilith),
	SPECIES_SPRITE(CORPOLITH,     gMonStillFrontPic_Corpolith),
	SPECIES_SPRITE(COCONIT,       gMonStillFrontPic_Coconit),
	SPECIES_SPRITE(PALMODON,      gMonStillFrontPic_Palmodon),
	SPECIES_SPRITE(CALFUMP,       gMonStillFrontPic_Calfump),
	SPECIES_SPRITE(SIRENITEE,     gMonStillFrontPic_Sirenitee),
	SPECIES_SPRITE(QUETINI,       gMonStillFrontPic_Quetini),
	SPECIES_SPRITE(QUETZIN,       gMonStillFrontPic_Quetzin),
	SPECIES_SPRITE(CASSOWILY,     gMonStillFrontPic_Cassowily),
	SPECIES_SPRITE(CATRIC,        gMonStillFrontPic_Catric),
	SPECIES_SPRITE(AMPEDO,        gMonStillFrontPic_Ampedo),
	SPECIES_SPRITE(ZAMIAD,        gMonStillFrontPic_Zamiad),
	SPECIES_SPRITE(FRONDULA,      gMonStillFrontPic_Frondula),
	SPECIES_SPRITE(SLOTHER,       gMonStillFrontPic_Slother),
	SPECIES_SPRITE(GLADITHER,     gMonStillFrontPic_Gladither),
	SPECIES_SPRITE(FRIONE,        gMonStillFrontPic_Frione),
	SPECIES_SPRITE(FRIGALA,       gMonStillFrontPic_Frigala),
	SPECIES_SPRITE(FRIGESTY,      gMonStillFrontPic_Frigesty),
	SPECIES_SPRITE(HELIMAW,       gMonStillFrontPic_Helimaw),
	SPECIES_SPRITE(COPRISAW,      gMonStillFrontPic_Coprisaw),
	SPECIES_SPRITE(BIBLIT,        gMonStillFrontPic_Biblit),
	SPECIES_SPRITE(BIBFERNO,      gMonStillFrontPic_Bibferno),
	SPECIES_SPRITE(ELASTRIKE,     gMonStillFrontPic_Elastrike),
	SPECIES_SPRITE(MAGVA,         gMonStillFrontPic_Magva),
	SPECIES_SPRITE(PUPAVA,        gMonStillFrontPic_Pupava),
	SPECIES_SPRITE(VOLQUITO,      gMonStillFrontPic_Volquito),
	SPECIES_SPRITE(CEBORA,        gMonStillFrontPic_Cebora),
	SPECIES_SPRITE(MANOBELLUM,    gMonStillFrontPic_Manobellum),
	SPECIES_SPRITE(COWRENSEA,     gMonStillFrontPic_Cowrensea),
	SPECIES_SPRITE(MAGMACLE,      gMonStillFrontPic_Magmacle),
	SPECIES_SPRITE(LIMPACLE,      gMonStillFrontPic_Limpacle),
	SPECIES_SPRITE(TERRISLA,      gMonStillFrontPic_Terrisla),
