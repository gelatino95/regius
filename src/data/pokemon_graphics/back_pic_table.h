...
//new pokemon
	...
	SPECIES_SPRITE(HATCHICK, gMonBackPic_Hatchick),
	SPECIES_SPRITE(CHICKLET, gMonBackPic_Chicklet),
	SPECIES_SPRITE(COCKATRIX, gMonBackPic_Cockatrix),
	SPECIES_SPRITE(LITTURCH, gMonBackPic_Litturch),
	SPECIES_SPRITE(PELURCHIN, gMonBackPic_Pelurchin),
	SPECIES_SPRITE(BENTHINE, gMonBackPic_Benthine),
	SPECIES_SPRITE(KELPENT, gMonBackPic_Kelpent),
	SPECIES_SPRITE(ALGOREST, gMonBackPic_Algorest),
	SPECIES_SPRITE(RADULIN, gMonBackPic_Radulin),
	SPECIES_SPRITE(TOXULA, gMonBackPic_Toxula),
	SPECIES_SPRITE(GLYPHMITE, gMonBackPic_Glyphmite),
	SPECIES_SPRITE(PYRAMITE, gMonBackPic_Pyramite),
	SPECIES_SPRITE(LEVILITH, gMonBackPic_Levilith),
	SPECIES_SPRITE(CORPOLITH, gMonBackPic_Corpolith),
	SPECIES_SPRITE(COCONIT, gMonBackPic_Coconit),
	SPECIES_SPRITE(PALMODON, gMonBackPic_Palmodon),
	SPECIES_SPRITE(CALFUMP, gMonBackPic_Calfump),
	SPECIES_SPRITE(SIRENITEE, gMonBackPic_Sirenitee),
	SPECIES_SPRITE(QUETINI, gMonBackPic_Quetini),
	SPECIES_SPRITE(QUETZIN, gMonBackPic_Quetzin),
	SPECIES_SPRITE(CASSOWILY, gMonBackPic_Cassowily),
	SPECIES_SPRITE(CATRIC, gMonBackPic_Catric),
	SPECIES_SPRITE(AMPEDO, gMonBackPic_Ampedo),
	SPECIES_SPRITE(ZAMIAD, gMonBackPic_Zamiad),
	SPECIES_SPRITE(FRONDULA, gMonBackPic_Frondula),
	SPECIES_SPRITE(SLOTHER, gMonBackPic_Slother),
	SPECIES_SPRITE(GLADITHER, gMonBackPic_Gladither),
	SPECIES_SPRITE(FRIONE, gMonBackPic_Frione),
	SPECIES_SPRITE(FRIGALA, gMonBackPic_Frigala),
	SPECIES_SPRITE(FRIGESTY, gMonBackPic_Frigesty),
	SPECIES_SPRITE(HELIMAW, gMonBackPic_Helimaw),
	...
	SPECIES_SPRITE(MAGVA, gMonBackPic_Magva),
	SPECIES_SPRITE(PUPAVA, gMonBackPic_Pupava),
	SPECIES_SPRITE(VOLQUITO, gMonBackPic_Volquito),
	SPECIES_SPRITE(CEBORA, gMonBackPic_Cebora),
	SPECIES_SPRITE(MANOBELLUM, gMonBackPic_Manobellum),
	SPECIES_SPRITE(COWRENSEA, gMonBackPic_Cowrensea),
	SPECIES_SPRITE(MAGMACLE, gMonBackPic_Magmacle),
	SPECIES_SPRITE(LIMPACLE, gMonBackPic_Limpacle),
	SPECIES_SPRITE(TERRISLA, gMonBackPic_Terrisla),
