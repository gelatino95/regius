...
//new pokemon
	...
	SPECIES_SHINY_PAL(DUNKEEP, gMonShinyPalette_Dunkeep),
	SPECIES_SHINY_PAL(DUNKASMA, gMonShinyPalette_Dunkasma),
	SPECIES_SHINY_PAL(HATCHICK, gMonShinyPalette_Hatchick),
	SPECIES_SHINY_PAL(CHICKLET, gMonShinyPalette_Chicklet),
	SPECIES_SHINY_PAL(COCKATRIX, gMonShinyPalette_Cockatrix),
	SPECIES_SHINY_PAL(LITTURCH, gMonShinyPalette_Litturch),
	SPECIES_SHINY_PAL(PELURCHIN, gMonShinyPalette_Pelurchin),
	SPECIES_SHINY_PAL(BENTHINE, gMonShinyPalette_Benthine),
	SPECIES_SHINY_PAL(KELPENT, gMonShinyPalette_Kelpent),
	SPECIES_SHINY_PAL(ALGOREST, gMonShinyPalette_Algorest),
	SPECIES_SHINY_PAL(RADULIN, gMonShinyPalette_Radulin),
	SPECIES_SHINY_PAL(TOXULA, gMonShinyPalette_Toxula),
	SPECIES_SHINY_PAL(GLYPHMITE, gMonShinyPalette_Glyphmite),
	...
	SPECIES_SHINY_PAL(CALFUMP, gMonShinyPalette_Calfump),
	SPECIES_SHINY_PAL(SIRENITEE, gMonShinyPalette_Sirenitee),
	SPECIES_SHINY_PAL(QUETINI, gMonShinyPalette_Quetini),
	SPECIES_SHINY_PAL(QUETZIN, gMonShinyPalette_Quetzin),
	SPECIES_SHINY_PAL(CASSOWILY, gMonShinyPalette_Cassowily),
	SPECIES_SHINY_PAL(CATRIC, gMonShinyPalette_Catric),
	SPECIES_SHINY_PAL(AMPEDO, gMonShinyPalette_Ampedo),
	SPECIES_SHINY_PAL(ZAMIAD, gMonShinyPalette_Zamiad),
	SPECIES_SHINY_PAL(FRONDULA, gMonShinyPalette_Frondula),
	SPECIES_SHINY_PAL(SLOTHER, gMonShinyPalette_Slother),
	SPECIES_SHINY_PAL(GLADITHER, gMonShinyPalette_Gladither),
	SPECIES_SHINY_PAL(FRIONE, gMonShinyPalette_Frione),
	SPECIES_SHINY_PAL(FRIGALA, gMonShinyPalette_Frigala),
	SPECIES_SHINY_PAL(FRIGESTY, gMonShinyPalette_Frigesty),
	SPECIES_SHINY_PAL(HELIMAW, gMonShinyPalette_Helimaw),
	...
	SPECIES_SHINY_PAL(MAGVA, gMonShinyPalette_Magva),
	SPECIES_SHINY_PAL(PUPAVA, gMonShinyPalette_Pupava),
	SPECIES_SHINY_PAL(VOLQUITO, gMonShinyPalette_Volquito),
	SPECIES_SHINY_PAL(CEBORA, gMonShinyPalette_Cebora),
	SPECIES_SHINY_PAL(MANOBELLUM, gMonShinyPalette_Manobellum),
	SPECIES_SHINY_PAL(COWRENSEA, gMonShinyPalette_Cowrensea),
	SPECIES_SHINY_PAL(MAGMACLE, gMonShinyPalette_Magmacle),
	SPECIES_SHINY_PAL(LIMPACLE, gMonShinyPalette_Limpacle),
	SPECIES_SHINY_PAL(TERRISLA, gMonShinyPalette_Terrisla),
