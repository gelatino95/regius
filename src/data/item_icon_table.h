const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_REGI_BALL] = {gItemIcon_RegiBall, gItemIconPalette_RegiBall},
    // Medicine
    ...
    // My items
    [ITEM_REGIUS_CREST] = {gItemIcon_RegiusCrest, gItemIconPalette_RegiusCrest},
    [ITEM_ELEGANT_KEY] = {gItemIcon_ElegantKey, gItemIconPalette_ElegantKey},
    [ITEM_OLD_KEY] = {gItemIcon_OldKey, gItemIconPalette_OldKey2},
    [ITEM_STONE_KEY] = {gItemIcon_StoneKey, gItemIconPalette_StoneKey},
    [ITEM_ANCIENT_SLAB] = {gItemIcon_AncientSlab, gItemIconPalette_AncientSlab},
    [ITEM_PLATE_FOSSIL] = {gItemIcon_PlateFossil, gItemIconPalette_PlateFossil},
    [ITEM_FROND_FOSSIL] = {gItemIcon_FrondFossil, gItemIconPalette_FrondFossil},
