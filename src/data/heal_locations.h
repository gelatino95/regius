static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GATEWAY_ISLAND - 1] = {MAP_GROUP(GATEWAY_ISLAND), MAP_NUM(GATEWAY_ISLAND), 34, 22},
    [HEAL_LOCATION_ARID_ISLAND - 1] = {MAP_GROUP(ARID_ISLAND), MAP_NUM(ARID_ISLAND), 18, 27},
    [HEAL_LOCATION_KAPOK_ISLAND - 1] = {MAP_GROUP(KAPOK_ISLAND), MAP_NUM(KAPOK_ISLAND), 14, 14},
    [HEAL_LOCATION_IGNEOUS_ISLAND - 1] = {MAP_GROUP(IGNEOUS_ISLAND), MAP_NUM(IGNEOUS_ISLAND), 25, 22},
};
