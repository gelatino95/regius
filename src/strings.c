...
const u8 gText_BirchBoy[] = _("ENERGETIC"); //modified
const u8 gText_BirchGirl[] = _("MELLOW"); //modified
...
const u8 gText_DefaultNameMarine[] = _("MARINE");
const u8 gText_ThisIsAPokemon[] = _("This is a POKéMON.{PAUSE 96}\p"); //modified
...
const u8 gText_DexHoennTitle[] = _("REGIUS DEX");
...
const u8 gText_DexHoennDescription[] = _("REGIUS island POKéDEX");
...
const u8 gText_DadsAdvice[] = _("GRANDMA's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the REGIUS islands.");
...
const u8 gText_BattleType[] = _("BATTLE TYPE");    //tx_optionsPlus
...
const u8 gText_DexHoenn[] = _("REGIUS");
