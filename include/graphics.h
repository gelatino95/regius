...
extern const u32 gBallGfx_Regi[];
extern const u32 gBallPal_Regi[];
...
extern const u32 gMonFrontPic_Dunkeep[];
extern const u32 gMonPalette_Dunkeep[];
extern const u32 gMonBackPic_Dunkeep[];
extern const u32 gMonShinyPalette_Dunkeep[];
extern const u32 gMonStillFrontPic_Dunkeep[];
extern const u8 gMonIcon_Dunkeep[];
extern const u8 gMonFootprint_Dunkeep[];

extern const u32 gMonFrontPic_Dunkasma[];
extern const u32 gMonPalette_Dunkasma[];
extern const u32 gMonBackPic_Dunkasma[];
extern const u32 gMonShinyPalette_Dunkasma[];
extern const u32 gMonStillFrontPic_Dunkasma[];
extern const u8 gMonIcon_Dunkasma[];
extern const u8 gMonFootprint_Dunkasma[];

extern const u32 gMonFrontPic_Hatchick[];
extern const u32 gMonPalette_Hatchick[];
extern const u32 gMonBackPic_Hatchick[];
extern const u32 gMonShinyPalette_Hatchick[];
extern const u32 gMonStillFrontPic_Hatchick[];
extern const u8 gMonIcon_Hatchick[];
extern const u8 gMonFootprint_Hatchick[];

extern const u32 gMonFrontPic_Chicklet[];
extern const u32 gMonPalette_Chicklet[];
extern const u32 gMonBackPic_Chicklet[];
extern const u32 gMonShinyPalette_Chicklet[];
extern const u32 gMonStillFrontPic_Chicklet[];
extern const u8 gMonIcon_Chicklet[];
extern const u8 gMonFootprint_Chicklet[];

extern const u32 gMonFrontPic_Cockatrix[];
extern const u32 gMonPalette_Cockatrix[];
extern const u32 gMonBackPic_Cockatrix[];
extern const u32 gMonShinyPalette_Cockatrix[];
extern const u32 gMonStillFrontPic_Cockatrix[];
extern const u8 gMonIcon_Cockatrix[];
extern const u8 gMonFootprint_Cockatrix[];

extern const u32 gMonFrontPic_Litturch[];
extern const u32 gMonPalette_Litturch[];
extern const u32 gMonBackPic_Litturch[];
extern const u32 gMonShinyPalette_Litturch[];
extern const u32 gMonStillFrontPic_Litturch[];
extern const u8 gMonIcon_Litturch[];
extern const u8 gMonFootprint_Litturch[];

extern const u32 gMonFrontPic_Pelurchin[];
extern const u32 gMonPalette_Pelurchin[];
extern const u32 gMonBackPic_Pelurchin[];
extern const u32 gMonShinyPalette_Pelurchin[];
extern const u32 gMonStillFrontPic_Pelurchin[];
extern const u8 gMonIcon_Pelurchin[];
extern const u8 gMonFootprint_Pelurchin[];

extern const u32 gMonFrontPic_Benthine[];
extern const u32 gMonPalette_Benthine[];
extern const u32 gMonBackPic_Benthine[];
extern const u32 gMonShinyPalette_Benthine[];
extern const u32 gMonStillFrontPic_Benthine[];
...
extern const u32 gMonFrontPic_Levilith[];
extern const u32 gMonPalette_Levilith[];
extern const u32 gMonBackPic_Levilith[];
extern const u32 gMonShinyPalette_Levilith[];
extern const u32 gMonStillFrontPic_Levilith[];
extern const u8 gMonIcon_Levilith[];
extern const u8 gMonFootprint_Levilith[];

extern const u32 gMonFrontPic_Corpolith[];
extern const u32 gMonPalette_Corpolith[];
extern const u32 gMonBackPic_Corpolith[];
extern const u32 gMonShinyPalette_Corpolith[];
extern const u32 gMonStillFrontPic_Corpolith[];
...
extern const u32 gMonFrontPic_Calfump[];
extern const u32 gMonPalette_Calfump[];
extern const u32 gMonBackPic_Calfump[];
extern const u32 gMonShinyPalette_Calfump[];
extern const u32 gMonStillFrontPic_Calfump[];
extern const u8 gMonIcon_Calfump[];
extern const u8 gMonFootprint_Calfump[];

extern const u32 gMonFrontPic_Sirenitee[];
extern const u32 gMonPalette_Sirenitee[];
extern const u32 gMonBackPic_Sirenitee[];
extern const u32 gMonShinyPalette_Sirenitee[];
extern const u32 gMonStillFrontPic_Sirenitee[];
...
extern const u32 gMonFrontPic_Catric[];
extern const u32 gMonPalette_Catric[];
extern const u32 gMonBackPic_Catric[];
extern const u32 gMonShinyPalette_Catric[];
extern const u32 gMonStillFrontPic_Catric[];
extern const u8 gMonIcon_Catric[];
extern const u8 gMonFootprint_Catric[];

extern const u32 gMonFrontPic_Ampedo[];
extern const u32 gMonPalette_Ampedo[];
extern const u32 gMonBackPic_Ampedo[];
extern const u32 gMonShinyPalette_Ampedo[];
extern const u32 gMonStillFrontPic_Ampedo[];
extern const u8 gMonIcon_Ampedo[];
extern const u8 gMonFootprint_Ampedo[];

extern const u32 gMonFrontPic_Zamiad[];
extern const u32 gMonPalette_Zamiad[];
extern const u32 gMonBackPic_Zamiad[];
extern const u32 gMonShinyPalette_Zamiad[];
extern const u32 gMonStillFrontPic_Zamiad[];
extern const u8 gMonIcon_Zamiad[];
extern const u8 gMonFootprint_Zamiad[];

extern const u32 gMonFrontPic_Frondula[];
extern const u32 gMonPalette_Frondula[];
extern const u32 gMonBackPic_Frondula[];
extern const u32 gMonShinyPalette_Frondula[];
extern const u32 gMonStillFrontPic_Frondula[];
extern const u8 gMonIcon_Frondula[];
extern const u8 gMonFootprint_Frondula[];

extern const u32 gMonFrontPic_Slother[];
extern const u32 gMonPalette_Slother[];
extern const u32 gMonBackPic_Slother[];
extern const u32 gMonShinyPalette_Slother[];
extern const u32 gMonStillFrontPic_Slother[];
extern const u8 gMonIcon_Slother[];
extern const u8 gMonFootprint_Slother[];

extern const u32 gMonFrontPic_Gladither[];
extern const u32 gMonPalette_Gladither[];
extern const u32 gMonBackPic_Gladither[];
extern const u32 gMonShinyPalette_Gladither[];
extern const u32 gMonStillFrontPic_Gladither[];
...
extern const u32 gMonFrontPic_Helimaw[];
extern const u32 gMonPalette_Helimaw[];
extern const u32 gMonBackPic_Helimaw[];
extern const u32 gMonShinyPalette_Helimaw[];
extern const u32 gMonStillFrontPic_Helimaw[];
extern const u8 gMonIcon_Helimaw[];
extern const u8 gMonFootprint_Helimaw[];

extern const u32 gMonFrontPic_Coprisaw[];
extern const u32 gMonPalette_Coprisaw[];
extern const u32 gMonBackPic_Coprisaw[];
extern const u32 gMonShinyPalette_Coprisaw[];
extern const u32 gMonStillFrontPic_Coprisaw[];
extern const u8 gMonIcon_Coprisaw[];
extern const u8 gMonFootprint_Coprisaw[];

extern const u32 gMonFrontPic_Biblit[];
extern const u32 gMonPalette_Biblit[];
extern const u32 gMonBackPic_Biblit[];
extern const u32 gMonShinyPalette_Biblit[];
extern const u32 gMonStillFrontPic_Biblit[];
extern const u8 gMonIcon_Biblit[];
extern const u8 gMonFootprint_Biblit[];

extern const u32 gMonFrontPic_Bibferno[];
extern const u32 gMonPalette_Bibferno[];
extern const u32 gMonBackPic_Bibferno[];
extern const u32 gMonShinyPalette_Bibferno[];
extern const u32 gMonStillFrontPic_Bibferno[];
...
extern const u32 gMonFrontPic_Cebora[];
extern const u32 gMonPalette_Cebora[];
extern const u32 gMonBackPic_Cebora[];
extern const u32 gMonShinyPalette_Cebora[];
extern const u32 gMonStillFrontPic_Cebora[];
extern const u8 gMonIcon_Cebora[];
extern const u8 gMonFootprint_Cebora[];

extern const u32 gMonFrontPic_Manobellum[];
extern const u32 gMonPalette_Manobellum[];
extern const u32 gMonBackPic_Manobellum[];
extern const u32 gMonShinyPalette_Manobellum[];
extern const u32 gMonStillFrontPic_Manobellum[];
extern const u8 gMonIcon_Manobellum[];
extern const u8 gMonFootprint_Manobellum[];

extern const u32 gMonFrontPic_Cowrensea[];
extern const u32 gMonPalette_Cowrensea[];
extern const u32 gMonBackPic_Cowrensea[];
extern const u32 gMonShinyPalette_Cowrensea[];
extern const u32 gMonStillFrontPic_Cowrensea[];
extern const u8 gMonIcon_Cowrensea[];
extern const u8 gMonFootprint_Cowrensea[];

extern const u32 gMonFrontPic_Magmacle[];
extern const u32 gMonPalette_Magmacle[];
extern const u32 gMonBackPic_Magmacle[];
extern const u32 gMonShinyPalette_Magmacle[];
extern const u32 gMonStillFrontPic_Magmacle[];
extern const u8 gMonIcon_Magmacle[];
extern const u8 gMonFootprint_Magmacle[];

extern const u32 gMonFrontPic_Limpacle[];
extern const u32 gMonPalette_Limpacle[];
extern const u32 gMonBackPic_Limpacle[];
extern const u32 gMonShinyPalette_Limpacle[];
extern const u32 gMonStillFrontPic_Limpacle[];
extern const u8 gMonIcon_Limpacle[];
extern const u8 gMonFootprint_Limpacle[];

extern const u32 gMonFrontPic_Terrisla[];
extern const u32 gMonPalette_Terrisla[];
extern const u32 gMonBackPic_Terrisla[];
extern const u32 gMonShinyPalette_Terrisla[];
extern const u32 gMonStillFrontPic_Terrisla[];
...
extern const u32 gTrainerFrontPic_DiverM[];
extern const u32 gTrainerFrontPic_DiverF[];
extern const u32 gTrainerFrontPic_Scientist[];
extern const u32 gTrainerFrontPic_DragonMaster[];
...
extern const u32 gTrainerPalette_DiverM[];
extern const u32 gTrainerPalette_DiverF[];
extern const u32 gTrainerPalette_Scientist[];
extern const u32 gTrainerPalette_DragonMaster[];
...
extern const u32 gItemIcon_RegiBall[];
extern const u32 gItemIconPalette_RegiBall[];
