...
#define MAP_ARID_ISLAND_HOUSE1         (1 | (35 << 8))
#define MAP_ARID_ISLAND_HOUSE2         (2 | (35 << 8))
...
// gMapGroup_IndoorNortheastSea

// gMapGroup_IndoorNorthwestSea
#define MAP_NORTHWEST_SEA_HOUSE1 (0 | (41 << 8))
#define MAP_NORTHWEST_SEA_HOUSE2 (1 | (41 << 8))

// gMapGroup_IndoorSouthwestSea
#define MAP_SOUTHWEST_SEA_HOUSE1 (0 | (42 << 8))

// gMapGroup_IndoorSouthSea
#define MAP_BIOLOGICAL_INSTITUTE_1F  (0 | (43 << 8))
#define MAP_BIOLOGICAL_INSTITUTE_B1F (1 | (43 << 8))
...
#define MAP_BATTLE_GROTTO_B2F            (2 | (45 << 8))
#define MAP_BATTLE_GROTTO_B3F            (3 | (45 << 8))
...
#define MAP_BATTLE_GROTTO_B7F            (8 | (45 << 8))

#define MAP_GROUPS_COUNT 46

// static const u8 MAP_GROUP_COUNT[] = {77, 5, 5, 6, 7, 8, 9, 7, 7, 14, 8, 17, 10, 23, 13, 15, 15, 2, 2, 2, 3, 1, 1, 1, 124, 61, 89, 2, 1, 13, 1, 1, 3, 1, 2, 5, 6, 2, 1, 1, 0, 2, 1, 2, 1, 9, 0};
